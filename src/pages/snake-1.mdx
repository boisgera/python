...
In this project you will create a classic video game, the 🐍 [snake game]! 
You will use Python and the [Pyxel] library.
...
what's going on.
When it's necessary, search into Pyxel's [user's guide] and [API reference].

[user's guide]: https://kitao.github.io/pyxel/web/user-guide/
[API reference]: https://kitao.github.io/pyxel/web/api-reference/

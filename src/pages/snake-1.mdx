...
<Image transition:name="snakeImage" src={snake} alt="Boa constrictor by Jan Kopřiva" style="border-radius: 0.375rem; width: 100%;"/>


<Admonition type="note" title="Attribution" open={true} lock>
The first version of this project was authored by Aurélien Noce (aka [@ushu](https://github.com/ushu)).
</Admonition>
...
The subject is a standard of video games, the 🐍 [snake] game!
...
<video controls width="768" style="border-radius: 0.375rem; width: 100%;">
...
<Image src={palette} alt="Pyxel's color palette" style="margin:auto;display:block;width:100%;"/>
...
<Image src={checkerboard} alt="A 30x30 checkerboard"  style="border-radius: 0.375rem; width: 100%;"/>
...
<Image src={fruit} alt="A fruit at a random location"  style="border-radius: 0.375rem; width: 100%;"/>
...
<Image src={restingSnake} alt="A resting snake"  style="border-radius: 0.375rem; width: 100%;"/>
...
<Admonition type="warning" title="🗲 OMG it's so fast!">

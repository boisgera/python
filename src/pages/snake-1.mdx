...
<Admonition type="note" title="Attribution" open={true} lock>
  The first version of this project was authored by Aurélien Noce (aka
...
Here is the kind of things that we expect to have at the end of this project
(click to play!):

import snakeGame from "/src/assets/web-snake-game.png";


<a href="../snake-game">
<Image
  src={snakeGame}
  alt="A Pyxel Snake Game"
  style="border-radius: 0.375rem; width: 100%; height: auto; height: auto;"
/>
</a>
...
- the snake should not be able to go through the rocks (yes, there are rocks!).

Since we are not too cruel, the snake doesn't die when such a collision occurs.
Instead, he loses one segment of it tail, until only the head remains.
